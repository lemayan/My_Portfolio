  ...
  return (
    <section onMouseMove={handleMouseMove} className="relative c-space section-spacing">
        ...
        {myProjects.map((project) => (
            <Project key={project.id} {...project} setPreview={!isMobile ? setPreview : () => {}} />
        ))}
      {!isMobile && preview && (  <motion.img  className="fixed top-0 left-0 z-50 object-cover h-56 rounded-lg shadow-lg pointer-events-none w-80"
