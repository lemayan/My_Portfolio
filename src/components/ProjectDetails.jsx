  ...
  return (
    ...
    <motion.div className='relative max-w-2xl border shadow-sm rounded-2xl bg-gradient-to-l from-midnight to-navy border-white/10 '
     ...
     animate={{ scale: 1, opacity: 1 }}>
        ...
        <img src={image} alt={title} className='w-full h-48 object-contain rounded-t-2xl' />
        <div className='p-5 '>
            ...
            <div className='flex items-center justify-between mt-4 '>
                ...
                <a href={href} target="_blank" rel="noopener noreferrer" className='inline-flex items-center gap-1 font-medium hover-animation cursor-pointer'>
                    View Project
